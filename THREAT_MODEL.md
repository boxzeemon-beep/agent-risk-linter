...
- A contributor who submits a malicious Skill, `AGENTS.md`, Codex lifecycle hook, MCP configuration, WebMCP site-tool registration, script, workflow, dependency, or rule change.
