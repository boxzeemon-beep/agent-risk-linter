...
git checkout 8ebecd44b9a9f5a1131cbec19aa40f461d66fb72
...
| MCP configuration and Codex hooks | unencrypted remote endpoints, shell-wrapped server commands, and lifecycle hooks that automatically invoke MCP tools |
...
jobs:
  scan:
    ...
    steps:
      ...
      - id: agent-risk
        uses: boxzeemon-beep/agent-risk-linter@8ebecd44b9a9f5a1131cbec19aa40f461d66fb72
        with:
          fail-on: high
      - if: always()
