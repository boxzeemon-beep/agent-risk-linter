...
- Add 30 deterministic rules across prompt injection, authorization, command execution, filesystem, credentials, network egress, supply chain, CI, MCP, WebMCP, obfuscation, and Skill metadata, including detection of command and MCP Codex lifecycle hooks, static MCP credential headers, and agent-callable site-tool registrations.
